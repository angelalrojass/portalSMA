                            ...
                            <form id="contactForm">
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-sm-4">
                                        <label for="name">Nombre <span class="text-lightred" style="font-size: 10px">*</span></label>
                                        <input name="name" type="text"  id="name" required>
                                    </div>

                                    <div class="form-group col-sm-4">
                                        <label for="email">Email <span class="text-lightred" style="font-size: 10px">*</span></label>
