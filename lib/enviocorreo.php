...
if($_POST['nombreU'] == '' or $_POST['apellido1U'] == '' or $_POST['apellido2U'] == ''or $_POST['sexoU'] == ''or $_POST['fechanacimientoU'] == ''
  or $_POST['entidadnacimientoU'] == ''or $_POST['estadoU'] == ''or $_POST['codigopostalU'] == ''or $_POST['coloniaU'] == ''or $_POST['telefonopU'] == ''or $_POST['telefonotUB'] == ''or $_POST['telefonocU'] == ''or $_POST['licenciadecU'] == ''or $_POST['vehiculopropioU'] == ''or $_POST['emailU'] == ''or $_POST['confirmaCorreoElectrnicoU'] == ''or $_POST['titulocurriculoU'] == ''or $_POST['objetivopU'] == ''or $_POST['idEstado'] == ''or $_POST['idMunicipio'] == ''or $_POST['habilidadesU'] == ''or $_POST['escuelaU'] == ''or $_POST['gradoacademicoU'] == ''or $_POST['titulogradoU'] == ''or $_POST['fechainicioesU'] == ''or $_POST['fechaterminoesU'] == ''or $_POST['auncursoU'] == ''or $_POST['nivelinglesU'] == ''or $_POST['trabajaactualmenteU'] == ''or $_POST['motivoU'] == ''or $_POST['otraU'] == ''or $_POST['fechaabuscarU'] == ''or $_POST['disponibilidadU'] == ''or $_POST['ultimopuestoU'] == ''or $_POST['empresaU'] == ''or $_POST['giroU'] == ''or $_POST['funcionesactividadesU'] == ''or $_POST['fechainicioultimotU'] == ''or $_POST['fechaterminoultimotU'] == ''or $_POST['empleoactualU'] == '')
    { 
