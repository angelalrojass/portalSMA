...
if ($result = mysqli_query($link, "SELECT * FROM codigopostal WHERE Codigopostalb='$CodPostal'")) {
    ...
    if( $row_cnt)
    {
        ...
        $row_cnt = mysqli_num_rows($result);
            ...
            echo '<input  class="form-control" value="'.$asentamiento1.'  name="telefonopU" id="telefonopU"  />';
    ...
    echo '<input type="text" class="form-control" name="coloniaU" id="coloniaU" value="NO existe dato" disabled/>';
