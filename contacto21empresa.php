                    ...
                    <div class="row">
                        ...
                        <div class="col-md-8">
                          ...
                          <table class="table table-bordered">  
                               <tr>  
                                    <th width="70%">ESPECIALIDAD O A FIN/ESCOLARIDAD/MUNICIPIO</th>  
                                    <th width="15%">VER</th>  
                               </tr>  
                               <?php  
                               ...
                               ?>  
                               <tr>  
                                    <td><?php echo $row["idEstado"]?>-<?php echo $row["idMunicipio"]?>/<?php echo $row["coloniab"]?>
                                                            
                                    </td>  
                                      
                                    <td>
                                      <a href='tabla2.php?no=<?php echo $row["id_empresab"]; ?>'><button type="button" class="btn-success">VER</button>
