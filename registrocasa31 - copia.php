...
<?php include("header.php");?>
 ...
 <div class="row">
                                  ...
                                  <div class="form-group col-sm-4">
                                        ...
                                        <input type='text' class="form-control" name="pais" id="estadoU" value="Estado de Mexico" disabled/>
 ...
 <div class="row">
                                  ...
                                  <div class="row">
                                    ...
                                    <div class="form-group col-sm-6" >
                                        ...
                                        <input name="emailU" type="emailU" class="form-control myInput" id="emailU1" >
                                        <div id="resvalemail"></div>

                                    </div>
                                    <div class="form-group col-sm-6">
                                        <label">Confirma Email <span class="text-lightred" style="font-size: 15px">*</span></label>
                                        <input name="confirmaCorreoElectronicoU" type="email"  onkeyUp="habilitar()"class="form-control myInput" id="confirmaCorreoElectronicoU1" disable >
                                        <div id="resvalemai"></div>
