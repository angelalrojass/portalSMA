...
$html = '<table width="700" border="0" cellspacing="0" cellpadding="0" style="font-family:Arial, Helvetica, sans-serif; font-size:10px;">
      ...
      <tr>
        <td height="12" align="center" style="font-family:Arial, Helvetica, sans-serif; font-size:10px; font-weight:300; background-color:#e6e6e6;">
      ...
      <tr>
        <td width="700" height="12" align="center" style="font-family:Arial, Helvetica, sans-serif; font-size:10px; font-weight:300; background-color:#e6e6e6;"><strong>DATOS DEL ESTABLECIMIENTO Y GIRO</strong></td>
      </tr>
      <tr>
        <td height="10" align="left" style="text-align:justify;;">&nbsp;</td>
      </tr>
      ...
      <tr>
        <td height="12" align="center" valign="middle" style="font-family:Arial, Helvetica, sans-serif; font-size:10px; font-weight:300;  background-color:#e6e6e6;"><strong>DATOS DEL INMUEBLE</strong></td>
        </tr>
      <tr>
        <td height="10" align="left" style="text-align:justify;;">&nbsp;</td>
      </tr>
...
$html2 = '<table width="700" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td height="10" align="left" style="font-family:Arial, Helvetica, sans-serif; font-size:8px; font-weight:300; "><table width="700" border="0" align="left" cellpadding="0" cellspacing="0" style="font-size:10px;">
      ...
      <tr>
        <td height="10" align="left" style="text-align:justify;;">
		<table width="700" border="0" align="left" cellpadding="0" cellspacing="0" style="font-size:10px;">
          <tr>
            <td width="700" height="10" valign="bottom" style="color:#000000; font-size: 8px;">
			Lo anterior está fundado, motivado y en su caso sancionado por los Artículos 7 fracción II, VI, VII Y VIII,13 Y 15, 16, 21 y 33 AL 45 y 180 de la ley de competitividad y ordenamiento comercial del Estado de México, así como el artículo 22 del reglamento de la misma ley en comento, así también los Artículo 6,7 y 40 del reglamento interno de las dependencias de la administración pública del ayuntamiento de San Mateo Atenco y el artículo 60 del Bando Municipal de Policía y Buen Gobierno de San Mateo Atenco para la administración 2016- 2018, adema de ser sancionado en su caso por Artículo 148 Bis, 165 bis, 167, 168 fracción XI del Código penal del Estado de México, sin perjuicio de las demás disposiciones normativas aplicables al caso que nos ocupa.
			</td>
          </tr>
        </table>
