...
$idUsuario = sanitize($_POST["usuario"]);
...
$guarda = "INSERT INTO `tesoreria`(`folio`, `monto`, `cveRecauda`, `tipoPago`, `banco`, `fechaPago`, `requiereFactura`) VALUES ('$folioSol','$importe_cedula','$claveDu','2','$banco', '$formatDate','1')";
