...
$html2 = '<table width="700" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td height="400" align="center" style="font-family:Arial, Helvetica, sans-serif; font-size:8px; font-weight:300; "></td>
  </tr>
  <tr>
...
//$mail­>AddAttachment($pat.'/'.$Folio.'/'.$pdf_name.'.pdf');
