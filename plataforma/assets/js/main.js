...
$(function() {
  ...
  SANMATEO.navbar = {
    ...
    init: function() {
      SANMATEO.navbar.menu();
      SANMATEO.navbar.ripple();
      SANMATEO.navbar.removeRipple();
      SANMATEO.navbar.collapse();
      SANMATEO.navbar.offcanvas();
    },
  ...
  SANMATEO.tiles = {
    ...
    init: function() {
      SANMATEO.tiles.toggle();
      SANMATEO.tiles.refresh();
      SANMATEO.tiles.fullscreen();
      SANMATEO.tiles.close();
    },
  ...
  SANMATEO.extra = {
    ...
    init: function() {
      SANMATEO.extra.sparklineChart();
      SANMATEO.extra.slimScroll();
      SANMATEO.extra.daterangePicker();
      SANMATEO.extra.easypiechart();
      SANMATEO.extra.chosen();
      SANMATEO.extra.toggleClass();
      SANMATEO.extra.colorpicker();
      SANMATEO.extra.touchspin();
      SANMATEO.extra.datepicker();
      SANMATEO.extra.animateProgress();
      SANMATEO.extra.counter();
      SANMATEO.extra.popover();
      SANMATEO.extra.tooltip();
      SANMATEO.extra.splash();
  ...
  SANMATEO.documentOnResize = {
      ...
      var t = setTimeout( function(){
        ...
        SANMATEO.documentOnReady.setSidebar();
        SANMATEO.navbar.removeRipple();
