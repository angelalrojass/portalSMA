...
//$civilUB = "2";
 ...
 //$query = "SELECT * FROM `empresab` WHERE `idEstado`='$civilUB'";  
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-8">
                            ...
                            <div class="heading-block mb-60">
                                <h2 class="text-uppercase"><span class="text-theme">Lista de empresa de acuedo a la especialidad</span> </h2>
                            </div>
                          ...
                          <table class="table table-bordered">  
                               ...
                               <tr>  
                                    <th width="70%">MENSAJE DE EMPRESA / ESCOLARIDAD / EDAD / SEXO / MUNICIPIO
                                      </th>  
                               </tr>  
